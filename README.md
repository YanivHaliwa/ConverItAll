...
| **ZIP / RAR / 7Z / TAR / TAR.GZ / TAR.BZ2 / TAR.XZ / TGZ** | zip, rar, 7z, tar |
...
> **Archives** are protected against zip-slip path traversal — malicious archives with `../` paths are rejected before extraction.
